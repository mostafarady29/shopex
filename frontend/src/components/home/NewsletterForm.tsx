          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                required
                className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-[#555] focus:outline-none focus:border-[#FF9900] transition-colors"
              />
              <button
                type="submit"
                className="bg-[#FF9900] hover:bg-[#E68A00] text-[#111] font-bold text-sm px-7 py-3 rounded-xl transition-colors flex-shrink-0 active:scale-95"
              >
                Subscribe
              </button>
            </form>
